                ...
                <div className="w-[100%] flex flex-col items-center text-xs sm:text-base font-medium font-[poppins] ">
                        ...
                        <div className="sm:w-[1440px] bg-[#F9F1E7] sm:h-[100px] h-auto p-3 sm:p-0 px-[100px] flex flex-wrap items-center gap-5 justify-between">
                                <div className="gap-6 flex-wrap justify-center flex">
                                        ...
                                        <div className="w-[237px]  flex items-center justify-end border-l border-black">
                                ...
                                <div className="gap-[20px] flex">
                                        <div className="flex gap-4 text-[20px] items-center">
                                                <p>Show</p>
                                                <button className="w-[55px] h-[55px]  bg-white text-[#9F9F9F]">
                                                        16
                                                </button>
                                        ...
                                        <div className="flex gap-4 items-center">
                                                <p>Short by</p>
                                                <button className="w-[188px] h-[55px] pr-[86px] bg-white text-[#9F9F9F]">
                                                        Default
                                                </button>
                                        </div>
                                </div>
