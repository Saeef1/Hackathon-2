...
import img from "../../../public/sofa/sofa.png"
import img2 from "../../../public/sofa/sofa2.png"
import Link from "next/link"
export default function Section() {
    return <>
        <div className="w-[100%] h-[830px] pt-[35px] flex justify-center">
            <div className="w-1241px h-730px flex gap-82">
                <div className="w-[553px] h-[500px] flex gap-8">
                    <div className=" flex-col flex gap-8">
                        <div className="w-[76px] h-[80px] rounded-[10px] pt-2 overflow-hidden bg-[#F9F1E7]">
                            <Image src={img} alt=""
                                width={83}
                                height={55}
                                objectFit="cover"
                        ...
                        <div className="w-[76px] h-[80px] rounded-[10px] pt-2 bg-[#F9F1E7]">
                            <Image src={img} alt=""
                                width={83}
                                height={55}
                                objectFit="cover    "
                    ...
                    <div className="w-[423px] h-[500px] rounded-[10px] relative bg-[#F9F1E7]">
                        <Image src={img2} alt=""
                            width={481}
                            height={390}
                            objectFit="cover"
                ...
                <div className="w-[606px] h-[730px]">
                    ...
                    <p className=" sm:w-[424px] w-[100%] text-[13px] font-normal leading-[20px]">
                        Setting the bar as one of the loudest speakers in its class, the Kilburn is a compact, stout-hearted hero with a well-balanced audio which boasts a clear midrange and extended highs for a sound.
                    </p>
                    <div className="flex flex-col my-5 gap-3 text-sm text-[#9F9F9F]">
                        <p>Size</p>
                        ...
                        <div className="grid grid-cols-4 gap-x-1 gap-y-3 w-[150px] text-[#9f9f9f]">
                            ...
                            <p className="col-span-2">Category</p> : <p>Sofas</p>
                            <p className="col-span-2">Tags</p> : <p className="w-[190px]">Sofa, Chair, Home, Shop</p>
                            <p className="col-span-2">Share</p> :<div className="flex gap-6 items-center" >
                                <button>
